...
import (
	...
	"github.com/GoyalIshaan/vidSmith/tree/master/services/packager/internal/config"
	"github.com/GoyalIshaan/vidSmith/tree/master/services/packager/internal/rabbit"
...
func main() {
	...
	// Create AWS session with explicit configuration
	...
	logger.Info("packager service started, waiting for messages...")
